...
Rscript  Manching/famrandfinal.R # You may need to change this depending on what exactly With.R is, but if it's a standard R script that can be run from command line, this would suffice
